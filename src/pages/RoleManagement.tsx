...
const roles = [
  {
    ...
    permissions: [
      ...
      'חסינות מלאה ממחיקה ואיפוס'
    ],
    color: 'bg-amber-50 text-amber-700 border-amber-200 shadow-[0_0_15px_rgba(212,175,55,0.2)]'
  },
  {
    id: 'super_admin',
    name: 'אדמין (Admin)',
  ...
  {
    id: 'team_leader',
    name: 'ראש צוות / ראשת צוות (Team Leader)',
    description: 'אחראי/ת על קבוצת מנהלים ומשודכים לפי שיוך קבוצתי.',
    permissions: [
